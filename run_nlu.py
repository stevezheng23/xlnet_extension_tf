...
from xlnet_util import create_run_config, XLNetConfig, XLNetModel
...
class XLNetModelBuilder(object):
    ...
    def get_model_fn(self,
        ...
        def model_fn(features,
            ...
            loss, token_predict_ids, sent_predict_ids = self._create_model(model_config, run_config,
                input_ids, input_masks, segment_ids, token_label_ids, sent_label_ids, token_label_list, sent_label_list, mode)
...
def main(_):
    ...
    model_config = XLNetConfig(json_path=FLAGS.model_config_path)
    run_config = create_run_config(False, True, FLAGS)
    ...
    model_fn = model_builder.get_model_fn(model_config, run_config, FLAGS.init_checkpoint, token_label_list, sent_label_list)
